...
Motor::Motor(uint8_t digitalOne, uint8_t digitalTwo, int pwmPin, uint8_t encoderA, uint8_t encoderB, MotorID motorID) : pid_straight_(kPStraight, kIStraight, kDStraight, kPidMinOutputLimit, kPidMaxOutputLimit, kPidMaxErrorSum, kPidMotorTimeSample)
{
  /*  */
...
void Motor::motorSpeedPID(double target_speed)
{
  ...
  pid_straight_.controlSpeed(RPM2RPS(target_speed_), current_speed_, tmp_pwm, pid_tics_, kPulsesPerRevolution, kPidCountTimeSamplesInOneSecond);
